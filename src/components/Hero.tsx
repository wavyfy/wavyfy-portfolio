    ...
    <section className="relative overflow-hidden pt-0 pb-0 md:pt-0 md:pb-28">
      <div className="relative max-w-8xl mx-auto px-2 sm:px-4 pt-5 pb-0">
        ...
        <Reveal delay={1} duration={1.5} y={30}>
          <div
            className="hidden lg:block absolute left-4 xl:left-8 top-0 w-58 space-y-3"
        ...
        <Reveal delay={1} duration={1.5} y={30}>
          <div
            className="hidden lg:block absolute right-4 xl:right-8 top-0 w-58 space-y-3"
            style={{ perspective: "1800px", transformStyle: "preserve-3d" }}
          >
            <TestimonialCard
        ...
        <Reveal delay={0.5} duration={1} y={10}>
          <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto p-7 md:pt-18 md:pb-10 ">
            {/* Status Badge */}
